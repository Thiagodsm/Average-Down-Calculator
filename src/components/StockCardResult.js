...
function StockCardResult({results}) {
  //console.log('result: ' + results);
  return (
    <Card className='mb-3 me-3' style={{ width: '100%', height:'100%'}}>
      <Card.Body>
        <Card.Title>Para alcançar o preço médio desejado (PMD) será necessário comprar R$ 7,895.50 reais ou 47 unidades do ativos em questão</Card.Title>
